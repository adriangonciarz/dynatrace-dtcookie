...
type Masking struct {
	IpAddressMasking              IpAddressMaskingOption `json:"ipAddressMasking"`
...
func (me *Masking) Schema() map[string]*hcl.Schema {
...
func (me *Masking) MarshalHCL() (map[string]interface{}, error) {
