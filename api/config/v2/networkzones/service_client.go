...
func (cs *ServiceClient) Create(item *NetworkZones) (string, error) {
...
func (cs *ServiceClient) Update(id string, item *NetworkZones) error {
...
func (cs *ServiceClient) Get(id string) (*NetworkZones, error) {
	if len(id) == 0 {
...
func (cs *ServiceClient) List() ([]string, error) {
	...
	if bytes, err = cs.client.GET("/settings/objects?schemaIds=builtin%3Anetworkzones&fields=objectId&pageSize=500", 200); err != nil {
		return nil, err
	}
