...
func (cs *ServiceClient) Create(item *DDUPool) (string, error) {
...
func (cs *ServiceClient) Update(id string, item *DDUPool) error {
...
func (cs *ServiceClient) Get(id string) (*DDUPool, error) {
	if len(id) == 0 {
