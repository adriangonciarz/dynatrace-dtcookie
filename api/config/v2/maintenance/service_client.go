...
func (cs *ServiceClient) Create(item *MaintenanceWindow) (string, error) {
...
func (cs *ServiceClient) Update(id string, item *MaintenanceWindow) error {
...
func (cs *ServiceClient) List() ([]string, error) {
	...
	if bytes, err = cs.client.GET("/settings/objects?schemaIds=builtin%3Aalerting.maintenance-window&fields=objectId&pageSize=500", 200); err != nil {
		return nil, err
	}
