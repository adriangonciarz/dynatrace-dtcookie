...
func (cs *ServiceClient) Create(item *IMSBridge) (string, error) {
...
func (cs *ServiceClient) Update(id string, item *IMSBridge) error {
...
func (cs *ServiceClient) Get(id string) (*IMSBridge, error) {
	if len(id) == 0 {
...
func (cs *ServiceClient) List() ([]string, error) {
	...
	if bytes, err = cs.client.GET("/settings/objects?schemaIds=builtin%3Aibmmq.ims-bridges&fields=objectId&pageSize=500", 200); err != nil {
		return nil, err
	}
