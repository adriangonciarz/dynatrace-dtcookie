...
func (cs *ServiceClient) Create(item *Filters) (string, error) {
...
func (cs *ServiceClient) Update(id string, item *Filters) error {
...
func (cs *ServiceClient) Get(id string) (*Filters, error) {
	if len(id) == 0 {
...
func (cs *ServiceClient) List() ([]string, error) {
	...
	if bytes, err = cs.client.GET("/settings/objects?schemaIds=builtin%3Amainframe.mqfilters&fields=objectId&pageSize=500", 200); err != nil {
		return nil, err
	}
