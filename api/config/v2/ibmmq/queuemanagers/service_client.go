...
func (cs *ServiceClient) Create(item *QueueManager) (string, error) {
...
func (cs *ServiceClient) Update(id string, item *QueueManager) error {
...
func (cs *ServiceClient) Get(id string) (*QueueManager, error) {
	if len(id) == 0 {
...
func (cs *ServiceClient) List() ([]string, error) {
	...
	if bytes, err = cs.client.GET("/settings/objects?schemaIds=builtin%3Aibmmq.queue-managers&fields=objectId&pageSize=500", 200); err != nil {
		return nil, err
	}
